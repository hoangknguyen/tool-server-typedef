...
exports.TAG_RULE_GROUP_VALIDATION_GROUPS = {
    NESTED: 'NESTED',
    ROOT: 'ROOT'
};
exports.TagRuleGroupSchema = {
    ...
    properties: {
        name: [{
                ...
                groups: [exports.TAG_RULE_GROUP_VALIDATION_GROUPS.NESTED, exports.TAG_RULE_GROUP_VALIDATION_GROUPS.ROOT]
            }],
        tags: [{
                type: class_validator_1.ValidationTypes.ARRAY_NOT_EMPTY,
                message: exports.TAG_RULE_GROUP_VALIDATION_ERRORS.TAGS_EMPTY,
                groups: [exports.TAG_RULE_GROUP_VALIDATION_GROUPS.ROOT]
            }],
        operator: [{
                type: class_validator_1.ValidationTypes.IS_NOT_EMPTY,
